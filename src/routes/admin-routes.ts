...
import { addStudent, updateStudent, createInterview, getAllInterviewsA, updateInterviewStatus, 
    ...
    getAllDepartments, getDefaultPassword, setDefaultPassword,getDepartment, deleteAllStudents,view_student,getInterwievResult, resetStudentPassword ,setPreferences , getPreferences} from "../controllers/admin-controller.js";
...
adminRouter.put("/setpreferance",verifyTokenAdmin, setPreferences );
adminRouter.get("/getpreferance",verifyTokenAdmin, getPreferences );
adminRouter.get("/getInterwievResult/:id/:rollNumber", verifyTokenAdmin, getInterwievResult);
