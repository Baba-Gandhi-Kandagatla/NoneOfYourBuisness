...
import { changePassword, get_profile, get_resume, getAllInterviews, getSpecificInterviews, uploadResume ,getInterwievResult, submitFeedback, getFeedback } from "../controllers/student-controller.js";
...
studentRouter.get("/get_interviews/:status",verifyTokenStudent,getSpecificInterviews);
